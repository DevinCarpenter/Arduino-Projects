...
int S3_Degree = 0;
int S4_Degree = 0;
int S1_Speed = 2; //controls how quickly the servo moves
int S2_Speed = 2; //controls how quickly the servo moves
int S3_Speed = 2; //controls how quickly the servo moves
int S4_Speed = 2; //controls how quickly the servo moves
int S1_Map = 0;
int S2_Map = 0;
int S3_Map = 0;
int S4_Map = 0;
