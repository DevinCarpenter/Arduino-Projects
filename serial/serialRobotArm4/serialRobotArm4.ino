 ...
 * Speed set to slow to avoid any damage to servo and allow for smoothest controls.
 * 
...
int S4_Limits[2] = {50,130};  // set limitations (min/max: 0->180)
...
int S3_Speed = 0;
int S4_Speed = 0;
int S1_Speed_Limit = 1; //controls how quickly the servo can move
int S2_Speed_Limit = 1; //controls how quickly the servo can move
int S3_Speed_Limit = 1; //controls how quickly the servo can move
